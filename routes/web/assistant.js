...
- Goals and Pledges: create/manage monthly, yearly, installment, or one-off pledge goals.
...
const TOOLS = [
  {
    name: 'create_goal',
    description: 'Create a new contribution goal/pledge category. Use when the user asks to create, add, start, or set up a new goal, target, fund, or pledge collection, AND you already know whether it is monthly, yearly, installment, or a one-off/event pledge.',
    input_schema: {
      type: 'object',
      properties: {
