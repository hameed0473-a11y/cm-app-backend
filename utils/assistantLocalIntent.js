...
const EXPENSE_CATEGORIES = ['Utility Bills', 'Staff Salaries', 'Maintenance', 'Cleaning', 'Security', 'Office Expenses', 'Event Expenses', 'Religious Activities', 'Garden & Landscaping', 'Construction & Renovation', 'Equipment Purchases', 'Insurance & Legal', 'Taxes & Government Fees', 'Vehicle Expenses', 'Technology & Software', 'Charity Payments', 'Miscellaneous', 'Others'];
...
const EXPENSE_CATEGORY_TRANSLATIONS = {
  ...
  de: ['Nebenkosten', 'Personalgehälter', 'Wartung', 'Reinigung', 'Sicherheit', 'Bürokosten', 'Veranstaltungskosten', 'Religiöse Aktivitäten', 'Garten & Landschaftsbau', 'Bau & Renovierung', 'Ausrüstungskäufe', 'Versicherung & Recht', 'Steuern & Behördengebühren', 'Fahrzeugkosten', 'Technologie & Software', 'Wohltätigkeitszahlungen', 'Sonstiges', 'Andere'],
  fr: ['Factures de services', 'Salaires du personnel', 'Entretien', 'Nettoyage', 'Sécurité', 'Frais de bureau', 'Frais d\'événement', 'Activités religieuses', 'Jardin et aménagement paysager', 'Construction et rénovation', 'Achats d\'équipement', 'Assurance et juridique', 'Impôts et frais gouvernementaux', 'Frais de véhicule', 'Technologie et logiciels', 'Paiements caritatifs', 'Divers', 'Autres'],
  es: ['Facturas de servicios', 'Salarios del personal', 'Mantenimiento', 'Limpieza', 'Seguridad', 'Gastos de oficina', 'Gastos de eventos', 'Actividades religiosas', 'Jardín y paisajismo', 'Construcción y renovación', 'Compras de equipo', 'Seguros y legal', 'Impuestos y tasas gubernamentales', 'Gastos de vehículo', 'Tecnología y software', 'Pagos de caridad', 'Varios', 'Otros'],
  ar: ['فواتير الخدمات', 'رواتب الموظفين', 'الصيانة', 'التنظيف', 'الأمن', 'مصاريف المكتب', 'مصاريف الفعاليات', 'الأنشطة الدينية', 'الحدائق وتنسيق المناظر الطبيعية', 'البناء والتجديد', 'شراء المعدات', 'التأمين والشؤون القانونية', 'الضرائب والرسوم الحكومية', 'مصاريف المركبات', 'التقنية والبرمجيات', 'مدفوعات خيرية', 'متفرقات', 'أخرى'],
  ru: ['Коммунальные платежи', 'Зарплаты персонала', 'Обслуживание', 'Уборка', 'Безопасность', 'Офисные расходы', 'Расходы на мероприятия', 'Религиозная деятельность', 'Сад и благоустройство', 'Строительство и ремонт', 'Покупка оборудования', 'Страхование и юридические услуги', 'Налоги и государственные сборы', 'Расходы на транспорт', 'Технологии и ПО', 'Благотворительные платежи', 'Разное', 'Другое'],
  pt: ['Contas de serviços', 'Salários da equipe', 'Manutenção', 'Limpeza', 'Segurança', 'Despesas de escritório', 'Despesas de eventos', 'Atividades religiosas', 'Jardim e paisagismo', 'Construção e reforma', 'Compras de equipamentos', 'Seguro e jurídico', 'Impostos e taxas governamentais', 'Despesas com veículos', 'Tecnologia e software', 'Pagamentos de caridade', 'Diversos', 'Outros'],
  zh: ['水电费', '员工工资', '维护', '清洁', '安保', '办公费用', '活动费用', '宗教活动', '花园与园艺', '建筑与翻新', '设备采购', '保险与法律', '税费与政府费用', '车辆费用', '技术与软件', '慈善捐款', '其他', '其他费用']
};
...
const CATEGORY_WORDS_STRIP_RE = /\b(monthly|yearly|annual(?:ly)?|event|one[- ]?off|pledge|instal(?:l)?ments?|monatlich|jährlich|einmalig\w*|zusage|ratenzahlung|raten|mensuel(?:le)?|annuel(?:le)?|ponctuel(?:le)?|promesse|versements?|échelonné\w*|mensual(?:es)?|anual(?:es)?|únic[oa]|promesa|cuotas|a plazos|mensal(?:is)?|anual|promessa|parcelas?|parcelado)\b|شهري|سنوي|مرة واحدة|تعهد|أقساط|ежемесячн\w*|ежегодн\w*|разов\w*|обещани\w*|рассрочк\w*|взнос\w*|月度|每月|年度|每年|一次性|认捐|分期|分期付款/gi;
